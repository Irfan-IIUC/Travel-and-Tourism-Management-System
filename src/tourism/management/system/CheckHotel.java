...
public class CheckHotel extends JFrame implements Runnable {
    ...
    CheckHotel() {
        ...
        caption = new JLabel();
        caption.setFont(new Font("serif", Font.BOLD, 35));
        caption.setForeground(Color.WHITE);
        caption.setBounds(50, 550, 1000, 70);

        for (int i = 0; i <= 9; i++) {

            image[i] = new ImageIcon(ClassLoader.getSystemResource("tourism/management/system/icons/hotel" + (i + 1) + ".jpg"));
